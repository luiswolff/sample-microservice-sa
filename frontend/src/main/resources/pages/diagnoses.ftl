            ...
            <tbody>
                <#list model.diagnoses as diagnosis >
                    <tr id="patients:${model.id}:diagnosis:${diagnosis?counter}">
                        ...
                        <td>
                            <input type="date" name="date" value="${diagnosis.date?string('yyyy-MM-dd')}" required="" title="The date when the diagnosis occurred" />
                        </td>
                        <td>
                            <input type="text" name="icd10" value="${diagnosis.icd10!}" title="The ICD-10 of the diagnosis if exists" />
                        </td>
                        <td>
    ...
    <form id="patients:${model.id}:diagnosis-add" action="/frontend/${model.id}/diagnoses/add" method="post">
        <table>
            ...
            <tr>
                ...
                <td><input id="icd10" type="text" name="icd10"/></td>
            </tr>
            <tr>
